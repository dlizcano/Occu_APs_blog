...
categories: [Multi-species model, code, analysis, WCS]
image: "image.png"
---
...
full_sites_14_15_16_sf_UTM <- full_sites_14_15_16_sf_UTM |> 
...
hist(full_sites_14_15_16_sf_UTM$border_dist)
...
save(fit.commu, file="C:/CodigoR/Occu_APs/Occu_APs_blog/posts/Llanganates/result/DR_result.R") # guardamos los resultados para no correr de nuevo
```
